          ...
          >
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-lg text-muted-foreground">
                I'm a Senior Full Stack Engineer with 10+ years Experiences.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              ...
              <div className="space-y-4 text-muted-foreground">
                ...
                <p>
                  Senior Full Stack Engineer professional with over IO years of
                  experience in delivering scalable SaaS and e-commerce
                  platforms, expert in React and Nodejs. Key achievements
                  include improving transaction success rates by 27% and
                  mplementing multilingual e-commerce platforms that increased
                  customer adoption by over 60%. Seeking a Senior Full Stack
                  Engineer position at Talkdesk, where my skills in SaaS and
                  e-commerce delivery can support the mission of driving
