  ...
  const featuredProjects = [
    {
      ...
      link: "/projects",
      // code: "https://github.com/Super93309/An_Income_Tax_Fraud_Detection_Using_AI-ML"
    },
    {
      ...
      link: "/projects",
      // code: "https://github.com/Super93309/Oral_Cancer_Classification"
    },
    {
      ...
      link: "/projects",
      // code: "https://github.com/Super93309/CC-Fraud-Detection"
    },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
              I'm a Computer Science student specializing in AI & ML. Passionate
              about programming, AI integration, and building innovative web
              applications.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-4 text-center">AI</h3>
              <p className="text-muted-foreground text-center">
