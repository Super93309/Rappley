  ...
  const experience = [
    {
      ...
      responsibilities: [
        "Architecting cloud-native full stack applications leveraging React,Vue, Node.js,AI/ML models, and cloud computing platforms, powering enterprise-grade fintech solutions",
        "Improved transaction success rates by 27% and enhanced fraud detection accuracy, safeguarding financial data and strengthening customer trust.",
        "Designed and deployed AI-driven customer support solutions that reduced resolution times by 33% and increased overall customer satisfaction scores.",
        "Optimized cloud infrastructure to achieve 18% cost reduction while maintaining 98% uptime across mission-critical fintech services.",
      ],
    },
    {
      ...
      responsibilities: [
        "Led development of multilingual e-commerce platforms with React,Vue, Node.js, and microservices architecture, powering international online retail operations.",
        "Increased system reliability by 42% and reduced downtime by 28% by implementing cloud-native architectures and proactive monitoring systems.",
        "Delivered mobile application solutions for global retail clients, boosting customer adoption by over 60% within the first year of release.",
        "Drove end-to-end product delivery cycles, from requirements gathering to deployment, aligning software features with evolving e-commerce trends.",
      ],
    },
    {
      ...
      type: "Personal Project",
      responsibilities: [
        "Developed and maintained scalable full stack applications using PHP, React,Vue,Angular, Node.js, MongoDB, and SQL, improving healthcare data management systems and patient service platforms.",
        "Optimized system performance, reducing API response time by 35%, which increased medical staff efficiency and improved patient record accessibility.",
        "Collaborated with cross-functional teams to integrate secure data handling protocols for sensitive healthcare records, ensuring compliance with GDPR and HIPAA standards.",
        "Contributed to product scalability that supported a 3x growth in active users, enabling successful expansion of the company’s healthcare SaaS offering.",
      ],
    },
  ];
  ...
  const projects = [
    {
      ...
      description:
        "Developed an AI-powered system to detect fraudulent activities in income tax filings using machine learning algorithms and data pattern analysis.",
      technologies: [
        "Python",
        "Machine Learning",
        "AI",
    ...
    },
    {
      ...
      description:
        "Built a deep learning model to detect and classify oral cancer stages from medical images, helping in early diagnosis and treatment planning.",
      technologies: [
        "Python",
        "TensorFlow",
        "Neural Networks",
    ...
    },
    {
      ...
      description:
        "Developed an object detection and tracking system using OpenCV and KCF Tracker that can identify and follow objects in video streams.",
    ...
    },
    {
      ...
      description:
        "Created a machine learning model to analyze whether credit card transactions are fraudulent by identifying unusual patterns and anomalies.",
      technologies: [
        "Python",
        "Machine Learning",
        "Data Science",
    ...
    },
    {
      ...
      description:
        "Built a Python package to run contextualized topic modeling with BERT embeddings, enabling more accurate text analysis and categorization.",
  ...
  const resumeHighlights = [
    {
      ...
      description:
        "Specialized in machine learning algorithms and AI applications with practical implementation experience",
