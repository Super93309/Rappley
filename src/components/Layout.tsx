      ...
      <footer className="w-full py-8 border-t border-muted relative z-10 backdrop-blur-md bg-black/20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex space-x-4">
                <motion.a
                  href="https://github.com/Super93309/"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/rui-pedro-dias-208326380"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-brand-purple transition-colors bg-secondary p-3 rounded-full"
                  whileHover={{ scale: 1.1 }}
                ...
                <motion.a
                  href="mailto:rui.pedro.dias724@gmail.com"
                  className="text-muted-foreground hover:text-brand-purple transition-colors bg-secondary p-3 rounded-full"
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.95 }}
                  aria-label="Email"
          ...
          <div className="text-muted-foreground text-sm text-center mt-8">
            © {new Date().getFullYear()} Rui Pedro Dias. All rights reserved.
          </div>
        </div>
      </footer>
      <ScrollToTop />
