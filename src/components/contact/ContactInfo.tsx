  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "rui.pedro.dias724@gmail.com",
      link: "mailto:rui.pedro.dias724@gmail.com",
    },
    {
      icon: <MapPin className="h-5 w-5 text-brand-purple" />,
      title: "Location",
      details: "Porto, Portugal",
      link: "https://maps.google.com/?q=Porto",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Super93309/",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/rui-pedro-dias-208326380",
    },
